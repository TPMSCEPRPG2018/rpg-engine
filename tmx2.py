...
class Map:
	def __init__(self, *, version: str, tiledversion: str, orientation: Orientation, renderorder: RenderOrder = RenderOrder.RIGHT_DOWN, width: SizeInTiles, height: SizeInTiles, tilewidth: SizeInPixels, tileheight: SizeInPixels, hexsidelength: SizeInPixels = None, staggeraxis: Axis = None, staggerindex: Parity = None, backgroundcolor: Color = None, nextlayerid: LayerID, nextobjectid: ObjectID, tilesets: List[Tileset] = (), **kwargs):
