...
def main():
	...
	RPGWindow(size=START_SIZE, start_map_path=MAP_PATH, tickrate=TICK_RATE, player_icon=player_icon, enemy_icon=enemy_icon, tile_size=TILE_SIZE, enemy_hp=ENEMY_HP, font_size=FONT_SIZE, font_color=FONT_COLOR).run()
